...
class CobolReport(BaseModel):
    """
    CobolReport is a Pydantic model that represents the response of the Cobol program analysis.
    """
    explanation: str = Field(..., description="The explanation of the Cobol program")
    identification_division_report: str = Field(..., description="A report about the identification division of the Cobol program")
    environment_division_report: str = Field(..., description="A report about the environment division of the Cobol program")
    data_division_report: str = Field(..., description="A report about the data division of the Cobol program")
    procedure_division_report: str = Field(..., description="A report about the procedure division of the Cobol program")

async def expand_query(
        q: str, *, model: str = "gpt-4o", temp: float = 0
) -> CobolReport:
    return await client.chat.completions.create(
        model=model,
        temperature=temp,
        response_model=CobolReport,
        messages=[
            {"role": "user", "content": q},
            {"role": "system", "content": "I want to analyze a Cobol program. Please give me information about the program as reports and how I could improve it."},
        ],
    )
